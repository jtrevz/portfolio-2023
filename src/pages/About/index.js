...
import aboutGradient from "../../assets/images/backgrounds/full-gradient.png";
import "./styles.css";

export default function About() {
  return (
    <Parallax id="about" pages={2}>
      ...
      <ParallaxLayer offset={1} speed={0.5} factor={1.5}>
        <Container fluid className="p-5">
          <Row className="mt-md-5">
            <h2 className="about-header px-5 pb-2">Experience</h2>
          </Row>
          <Row className="d-flex justify-content-end">
            <Col className="col-12 col-md-9">
              <Container fluid className="py-3 border">
                ...
                <Row className="d-flex justify-content-end m-4 my-5">
                  <Button className=" d-block btn-warning resume-button">
                    Resume
                  </Button>
                </Row>
              </Container>
